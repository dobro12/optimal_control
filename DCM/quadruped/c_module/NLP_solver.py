...
class Agent:
    def __init__(self, env=None):
        ...
        ang_coeff = 0.5
        self.Qf_rate = 100.0
        Q_mat = diag_mat([pos_coeff]*3 + [pos_coeff*ang_coeff]*3 + [pos_coeff*vel_coeff]*3 + [pos_coeff*ang_coeff*vel_coeff]*3)
        '''
        pos_coeff = 20.0
        vel_coeff = 0.025
        ang_coeff = 0.75
        ...
        self.R_mat = 0.1*np.eye(self.u_dim)
        ...
        self.mu_scaling_factor = 3.0 #2.0
    ...
    def get_action(self, init_x, init_u_list, delta_time_list, foot_pos_list, contact_phi_list, target_x_list, target_u_list):
        ...
        R_mat = self.R_mat
        Qf_mat = self.Q_mat*self.Qf_rate
        Q_mat = self.Q_mat
